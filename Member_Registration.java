...
class aMemberRegistration extends JFrame implements ActionListener {
    ...
    aMemberRegistration() {
        ...
        ImageIcon i1 = new ImageIcon("D:\\LibraryManageementSystem\\lib(1).jpg");
        ...
        swapTimer = new Timer(10, new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                leftPanelX = leftPanel.getX();
                rightPanelX = rightPanel.getX();

                if (direction == 1) {
                    if (leftPanelX < 500) {
                        leftPanel.setLocation(leftPanelX + 10, 0);
                        rightPanel.setLocation(rightPanelX - 10, 0);
                    } else {
                        swapTimer.stop();
                        leftPanel.removeAll();
    ...
    private void updateFeesBasedOnMembership() {
        ...
        if (selectedMembership != null) {
            try (BufferedReader reader = new BufferedReader(new FileReader("D:\\LibraryManageementSystem\\fees.txt"))) {
                String line;
    ...
    private void showLoginPage() {
        ...
        requestMembershipButton.setBounds(150, 300, 200, 35);
        requestMembershipButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (password.equals(confirmPassword) && !password.isEmpty()) {
                    try (BufferedWriter writer = new BufferedWriter(new FileWriter("D:\\LibraryManageementSystem\\memberrequest.txt", true))) {
                    ...
                    try (BufferedWriter writer = new BufferedWriter(new FileWriter("D:\\LibraryManageementSystem\\Members_with_credentials.txt", true))) {
        ...
        leftPanel.add(requestMembershipButton);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == confirmButton) {
            if (termsCheckBox.isSelected() && !firstname_f.getText().isEmpty() && !lastname_f.getText().isEmpty() && !contactnumber_f.getText().isEmpty() && !email_f.getText().isEmpty() && !permanentaddress_f.getText().isEmpty() && !Voter_id.getText().isEmpty()) {
                try (BufferedWriter writer = new BufferedWriter(new FileWriter("D:\\LibraryManageementSystem\\Members_information.txt", true))) {
                    writer.write(
